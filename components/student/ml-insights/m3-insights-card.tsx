      ...
      <div className="flex flex-wrap items-center gap-3">
        {atRisk ? (
          <>
            ...
            <p className="text-sm text-muted-foreground">
              The model flags a higher chance of at-risk status next semester. Early support can
              change this outcome.
            </p>
          </>
        ) : (
...
export function M3InsightsCard({ model }: { model: MlModelInsight }) {
  return (
    <ModelCard
      ...
      subtitle="A future-risk model prediction with the signals behind it and suggested next steps."
