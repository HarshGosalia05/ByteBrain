...
export function FacultyM2TPCard({ data, reason = null }: Props) {
  ...
  return (
    <ModelCard
      id="faculty-ml-insights-m2tp"
      icon={GraduationCap}
      title="Next-Semester Performance"
      subtitle="Predicted academic performance for this student's upcoming regular semester across Theory and Practical coursework."
...
function M2TPUnavailableCard({ reason }: { reason: string | null }) {
  return (
    <ModelCard
      ...
      icon={GraduationCap}
      title="Next-Semester Performance"
      subtitle="AI-estimated academic performance for this student's upcoming regular semester across Theory and Practical coursework."
      badge={<Badge variant="secondary">M2-TP · Next semester</Badge>}
    >
      <div
        role="status"
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-xs leading-relaxed text-muted-foreground">
            {reason ??
              "There is no upcoming normal academic semester with regular Theory or Practical coursework at this student's current academic stage (e.g. final internship semester)."}{" "}
