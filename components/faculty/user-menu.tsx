...
export function UserMenu({ profile }: { profile: FacultyProfile | null }) {
  ...
  const facultyId = profile?.faculty_id ?? null

  const meta = [designation, department].filter(Boolean).join(" • ")
  ...
  return (
    <Menu.Root>
      ...
      >
        <AvatarInitials firstName={first} lastName={last} />
