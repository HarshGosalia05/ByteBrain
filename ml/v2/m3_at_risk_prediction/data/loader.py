"""M3 v2 — Data Loader: read-only Supabase extraction.

Loads all tables required for the 1200-student CSE 6A cohort at-risk
(next-semester) prediction via asyncpg. NO writes, NO inserts, NO updates,
...
the same convention used by the backend and by M1/M2 v2.
...
class SupabaseLoader:
    """Read-only loader for M3 v2 training data from Supabase."""
